            ...
            <div className="p-6">
              ...
              {activeTab === 'imageEditor' && (
                <div className="space-y-6">
                  ...
                  {/* Editor de PDF Online via iframe */}
                  <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-700 p-6 mb-6">
                    <div className="flex items-center mb-4">
                      <FileText className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-2" />
                      <h3 className="text-lg font-medium text-gray-900 dark:text-white">Editor de PDF Online</h3>
                    </div>
