              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center space-x-2 ml-4">
                  <button
                    ...
                    className="flex items-center px-3 py-1.5 text-sm bg-blue-100 text-blue-700 border border-blue-200 rounded-lg hover:bg-blue-200 transition-colors"
                    title="Testar"
                  >
                  ...
                  <button 
                    ...
                    className="flex items-center px-3 py-1.5 text-sm bg-green-100 text-green-700 border border-green-200 rounded-lg hover:bg-green-200 transition-colors"
                  >
                  ...
                  <button className="flex items-center px-3 py-1.5 text-sm bg-red-100 text-red-700 border border-red-200 rounded-lg hover:bg-red-200 transition-colors">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md mx-4">
            ...
            <div className="flex justify-end space-x-3 p-6 border-t border-gray-200 dark:border-gray-700">
              <button
                onClick={() => setShowAddModal(false)}
                className="px-4 py-2 text-gray-600 bg-gray-100 border border-gray-200 rounded-lg hover:bg-gray-200 transition-colors"
              >
                Cancelar
              </button>
              <button
                ...
                className="px-4 py-2 bg-blue-100 text-blue-700 border border-blue-200 rounded-lg hover:bg-blue-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Adicionar API
              </button>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md mx-4">
            ...
            <div className="flex justify-end space-x-3 p-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-100 text-blue-700 border border-blue-200 rounded-lg hover:bg-blue-200 transition-colors"
              >
                Salvar Alterações
              </button>
            </div>
